...
```javascript
import Vue from 'vue';
import ElementUI from 'eavic-pc-ui';
import 'eavic-pc-ui/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'eavic-pc-ui';
import App from './App.vue';
...
```js
import Vue from 'vue';
import { Button } from 'eavic-pc-ui';
